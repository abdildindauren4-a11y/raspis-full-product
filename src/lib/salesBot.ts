...
=== ОСЫ ЧАТТА ДЕМО ЖАСАУҒА БОЛАДЫ (маңызды — осыны ұсын!) ===
Клиент осы чаттың өзінде демо-кесте жасай алады, ешқайда кірмей-ақ:
1. Чаттың астындағы «Үлгіні алу» батырмасы — Excel үлгісін жүктейді
2. Клиент 3-4 сыныптың деректерін толтырады (сыныптар, мұғалімдер, оқу жоспары)
3. «Толтырылған үлгіні жүктеу» батырмасымен файлды осында жүктейді
4. Кесте секундтар ішінде құрылып, дайын Excel файлы бірден жүктеледі
ШЕКТЕУ: демо ең көбі 4 сынып қабылдайды. Толық мектеп (мысалы 1-11 сыныптар)
кестесі — тек тарифпен. Клиент қызықса — алдымен ОСЫ демоны ұсын, бұл ең
күшті сату құралы (өз деректерімен нәтижені өз көзімен көреді).
...
export function cannedAnswer(msg: string): string {
  ...
  if (/демо|көрсетілім|показ|посмотреть|көру|көрейін/.test(m)) {
    return `Осы чаттың өзінде демо жасай аламын! 🙂\n\n1. Төмендегі **«Үлгіні алу»** батырмасын басыңыз — Excel үлгісі жүктеледі\n2. 3-4 сыныптың деректерін толтырыңыз (сыныптар, мұғалімдер, оқу жоспары)\n3. **«Толтырылған үлгіні жүктеу»** батырмасымен файлды осында жүктеңіз\n\nКесте секундтар ішінде құрылып, дайын Excel файлын бірден аласыз.\n\nТолық мектеп кестесі керек болса — ${wa}`;
  }
