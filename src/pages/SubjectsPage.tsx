      ...
      <GlassCard hover={false}>
        <div className="overflow-x-auto -mx-1 px-1"><table className="w-full text-sm min-w-[640px]">
          <thead>
            <tr className="text-left text-muted-c border-b border-soft-c">
              ...
              {activeEngine === "v2" && <th className="text-center">Тыйым</th>}
            </tr>
          </thead>
          <tbody>
            {subjects.map((s) => (
        ...
        {activeEngine !== "v2" && (
          <p className="text-xs text-faint-c mt-3">
            «Хамелеон» моделін таңдасаңыз, әр пәннің тыйым салынған уақыттарын осы жерден баптай аласыз.
          </p>
        )}
      </GlassCard>
    </div>
